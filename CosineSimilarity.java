/* 	Author:   	Mohit Mishra (Roll: 11100EN060)
	Date:		Dec. 2014
   	Aim: 	        Cosine Similarity between two given text
	Language: 	Java
	Assumption:	Two given strings of words separated by space
	Theory:		http://en.wikipedia.org/wiki/Cosine_similarity
*/
...
class Cosine_Similarity
{
 ...
 {
  System.out.println("**********************************************************");
  System.out.println("      DEMO: COSINE SIMILARITY BETWEEN TWO GIVEN TEXT           ");
  System.out.println("\n Author: Mohit Mishra, Roll: 11100EN060 \n Date: Dec. 2014\n Language used: Java\n Assumption: Two given strings");
  System.out.println("**********************************************************\n");
